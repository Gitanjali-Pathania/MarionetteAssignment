                                                            ...
                                                            if(email && password){
                                                                $.ajax({
                                                                      ...
                                                                      success: function(response){
                                                                        ...
                                                                        var template= Handlebars.compile('<div class="row" style="height:100%;margin: 5%"><div class="row" style="height:50px;widht:100%;margin-top: -4%;"><ul class="nav navbar-nav"><li class="dropdown"><a id="logout" style="line-height: 5px; ! important" class="dropdown-toggle" data-toggle="dropdown">'+email+'<span class="glyphicon glyphicon-user pull-right">Logout</span></a><ul class="dropdown-menu"><li><a  class"menuLinks" >Logout<span class="glyphicon "></span></a></li></ul></li></ul></div><div class="row" style="height:calc(100% - 100px);widht:100%;margin:0px"><div class="row" style="height:10px"> <h3>Add Reminder</h3></div><div class="row" style="height:5%;margin-top: 5%;margin-left: -3%;"><div class="col-md-6"><input type="text" class="form-control"  id="reminderId" placeholder="Add Reminder Message"/></div><div class="col-md-2"><input type="text"  id="phnId" class="form-control"  placeholder="Phone Number"/></div><div class="col-md-3"><input type="text" class="form-control" id="dateId" placeholder="Date and Time"/></div><div class="col-md-1"><button id="addReminder" class="form-control" >Add</button></div></div><div class="row" style="height:10px;margin-top: 1%;margin-bottom:3%"> <h3>Upcoming Reminders</h3></div><div class="row" style="height:35%;overflow-y: scroll;overflow-x: hidden;" id="upcomingReminder"></div><div class="row" style="height:10px;margin-bottom: 40px;"><h3> Past Reminders</h3></div><div class="row" style="height:35%;overflow-y: scroll;overflow-x: hidden;" id="pastReminder"></div></div></div>');
